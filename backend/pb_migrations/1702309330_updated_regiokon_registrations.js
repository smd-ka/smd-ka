...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("hizrj6kj")

  // remove
  collection.schema.removeField("oofj9bjd")

  // remove
  collection.schema.removeField("gqpu63w3")

  // remove
  collection.schema.removeField("ipogegk0")

  // remove
  collection.schema.removeField("nx3wuw03")

  // remove
  collection.schema.removeField("xogqsabg")

  // remove
  collection.schema.removeField("zvxflvc3")

  // remove
  collection.schema.removeField("ocnbtkmq")

  // remove
  collection.schema.removeField("z7g2cu4o")

  // remove
  collection.schema.removeField("errfrszq")

  // remove
  collection.schema.removeField("1ayyuivi")
