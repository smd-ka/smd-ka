...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("yttn0vlu")

  // remove
  collection.schema.removeField("c7ojgnuu")

  // remove
  collection.schema.removeField("ny9ewvir")

  // remove
  collection.schema.removeField("nfzmfrix")

  // remove
  collection.schema.removeField("vsyme5xt")
