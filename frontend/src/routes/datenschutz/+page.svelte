<main class="container mx-auto py-24 text-lg">
	<div class="container flex flex-col gap-6 px-4 xl:px-80">
		...
		<p>
			Diese Daten verwenden wir, um zum einen analysieren zu können, wie viele (unterschiedliche)
			Besucher zu welcher Zeit unsere Seite besuchen (und woher sie kommen) und zum anderen, um im
			Fall eines Angriffs nachvollziehen zu können, woher die Zugriffe kamen.
		</p>
